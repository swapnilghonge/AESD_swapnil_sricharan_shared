...
int main()
{
	...
	while(1){
		...
		// temp coefficents
		int dig_T1 = (b1[0] + (b1[1] << 8));
		int dig_T2 = (b1[2] + (b1[3] << 8));
		dig_T2 = dig_T2 > 32767?dig_T2 - 65536:dig_T2;
		int dig_T3 = (b1[4] + (b1[5] << 8));
		...
		long adc_p = ((long)(data[0] >> 16 + ((long)(data[1] << 8) + (long)(data[2] & 0xF0)))) >> 4;
		long adc_t = ((long)(data[3] >> 16 + ((long)(data[4] << 8) + (long)(data[5] & 0xF0)))) >> 4;
		// Convert the humidity data
		long adc_h = (data[6] << 8 + data[7]);
